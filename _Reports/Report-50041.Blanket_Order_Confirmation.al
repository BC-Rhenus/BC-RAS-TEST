report 50041 "Blanket Order Confirmation"

//  RHE-TNA 10-02-2022 BDS-6110
//  - New Report

{
    DefaultLayout = RDLC;
    RDLCLayout = './Rhenus Blanket Order Confirmation.rdl';
    Caption = 'Blanket Order Confirmation';
    ...
    var
        ...
        Text003: Label 'COPY';
        Text004: Label 'Blanket Order Confirmation%1';
        ...
        OrderNoCaptionLbl: Label 'Blanket Order No.';
