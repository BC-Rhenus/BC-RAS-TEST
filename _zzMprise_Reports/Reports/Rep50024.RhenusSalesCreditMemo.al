report 50024 "Rhenus Sales - Credit Memo"
...
//  RHE-TNA 27-01-2022 BDS-6037
//  - Modified trigger OnAfterGetRecord()

//  RHE-TNA 24-05-2022 BDS-6347
//  - Modified trigger OnAfterGetRecord()

{
    // version NAVW18.00.00.39663

    DefaultLayout = RDLC;
    RDLCLayout = './Rhenus Sales - Credit Memo.rdlc';
        ...
        dataitem("Sales Cr.Memo Header"; "Sales Cr.Memo Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    //RHE-TNA 27-01-2022 BDS-6037 BEGIN
                    /*
                    ...
                    */
                    ...
                    //RHE-TNA 27-01-2022 BDS-6037 END
                    ...
                    column(CompanyInfoFaxLbl; CompanyInfoFaxLbl)
                    {
                    }
                    column(CompanyInfoIBANLbl; CompanyInfoIBANLbl)
                    {
                    }
                    column(CompanyInfoIBAN; CompanyInfo.IBAN)
                    {
                    }
                    column(CompanyInfoSWIFTLbl; CompanyInfoSWIFTLbl)
                    {
                    }
                    column(CompanyInfoSWIFT; CompanyInfo."SWIFT Code")
                    {
                    }
                    column(CreditToLbl; CreditToLbl)
                    {
                    }
                    ...
                    dataitem("Sales Cr.Memo Line"; "Sales Cr.Memo Line")
                    {
                        ...
                        begin
                            ...
                            //RHE-TNA 19-11-2021 BDS-5858 BEGIN
                            /*
                            if (("Sales Cr.Memo Header"."VAT Bus. Posting Group" = 'NON-EU B2B') or ("Sales Cr.Memo Header"."VAT Bus. Posting Group" = 'NON-EU B2C')) then begin
                                gTxtVat := TxtVat1;
                                gTxtFooter := TxtFooter1;
                            end;
                            if "Sales Cr.Memo Header"."VAT Bus. Posting Group" = 'EU B2B' then begin
                                gTxtVat := TxtVat2;
                                gTxtFooter := TxtFooter2;
                            end;
                            if (("Sales Cr.Memo Header"."VAT Bus. Posting Group" = 'NL 0%') or ("Sales Cr.Memo Header"."Bill-to Customer No." = '1000')) then begin
                                gTxtVat := TxtVat3;
                                gTxtFooter := TxtFooter3;
                            end;
                            */
                            if VATBusPostingGroup.Get("Sales Cr.Memo Header"."VAT Bus. Posting Group") then begin
                            ...
                            //RHE-TNA 24-05-2022 BDS-6347 BEGIN
                            else
                            ...
                            //RHE-TNA 24-05-2022 BDS-6347 END
                        end;
    ...
    var
        ...
        Text004: Label 'COPY';
        Text005: Label 'Sales - Credit Note%1';
        ...
        CompanyInfoBankNameCptnLbl: Label 'Bank Information';
        ...
        CompanyInfoSWIFTLbl: Label 'Swift Code';
        CompanyInfoIBANLbl: Label 'IBAN';
        ItemLbl: Label 'Item';
        CreditNoteNoLbl: Label 'Credit Note No.';
        CreditToLbl: Label 'Credit To:';
