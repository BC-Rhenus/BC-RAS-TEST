report 50020 "Rhenus Sales Invoice"
...
{
    // version NAVW18.00.00.38798

    DefaultLayout = RDLC;
    //RDLCLayout = 'Rhenus Sales - Invoice.rdlc';
    RDLCLayout = 'Rhenus Sales - Invoice.rdl';
    Caption = 'Rhenus Sales - Invoice';
        ...
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(CompanyInfoBankSWIFTLbl; CompanyInfoBankSWIFTLbl)
                    {
                    }
                    column(CompanyInfoBankIBAN; CompanyInfo.IBAN)
                    {
                    }
                    column(CompanyInfoBankIBANLbl; CompanyInfoBankIBANLbl)
                    {
                    }
                    column(CompanyInfoBankLbl; CompanyInfoBankLbl)
                    {
                    }
                    ...
                    column(CompanyInfoFaxNoLbl; CompanyInfoFaxNoLbl)
                    {
                    }
                    ...
                    column(ExtDocNr; "Sales Invoice Header"."External Document No.")
                    {
                    }
                    column(ShipDate; FORMAT("Sales Invoice Header"."Shipment Date"))
                    {
                    }
                    column(ShipDateLbl; PostedShipmentDateCaptionLbl)
                    {
                    }
                    column(Carrier; "Sales Invoice Header"."Shipping Agent Code")
                    {
                    }
                    column(Tod; "Sales Invoice Header"."Shipment Method Code")
                    {
                    }
                    column(ExtDocNrLbl; ExtDocNrLbl)
                    {
                    }
                    ...
                    dataitem("Sales Invoice Line"; "Sales Invoice Line")
                    {
                        ...
                        column(Desc2_SalesInvLine; "Sales Invoice Line"."Description 2")
                        {
                        }
                        ...
                        column(Qty_SalesInvLineCaption; QtyCaption)
                        {
                        }
                        ...
                        column(ItemLbl; ItemNoCaption)
                        {
                        }
                        column(QtyLbl; QtyCaption)
                        {
                        }
                        ...
                        column(LineAmountInclVATCaption; FieldCaption("Amount Including VAT"))
                        {
                        ...
                        column(PrintLine; SetPrintableLine("Sales Invoice Line"))
                        {
                        ...
                        begin
                            ...
                            //  CL-IT 10-08-2016 - added ACC REC to the condition
                            // IF ((("Sales Invoice Header"."VAT Bus. Posting Group" = 'NON-EU B2B') AND ("Sales Invoice Header"."Customer Posting Group" = 'NON-EU')) OR ("Sales Invoice Header"."VAT Bus. Posting Group" = 'NON-EU B2C')) THEN BEGIN
                            //RHE-TNA BEGIN, Do not use predefined text, but use setup table
                            //IF ((("Sales Invoice Header"."VAT Bus. Posting Group" = 'NON-EU B2B') AND (("Sales Invoice Header"."Customer Posting Group" = 'NON-EU') OR ("Sales Invoice Header"."Customer Posting Group" = 'ACC REC')))
                            //      OR ("Sales Invoice Header"."VAT Bus. Posting Group" = 'NON-EU B2C')) THEN BEGIN
                            //    gTxtVat := TxtVat1;
                            //    gTxtFooter := TxtFooter1;
                            //END;
                            //IF "Sales Invoice Header"."VAT Bus. Posting Group" = 'EU B2B' THEN BEGIN
                            //    gTxtVat := TxtVat2;
                            //    gTxtFooter := TxtFooter2;
                            //END;
                            //IF "Sales Invoice Header"."VAT Bus. Posting Group" = 'NL 0%' THEN BEGIN
                            //    gTxtVat := TxtVat3;
                            //    gTxtFooter := TxtFooter3;
                            //END;
                            //IF (("Sales Invoice Header"."VAT Bus. Posting Group" = 'NON-EU B2B') AND ("Sales Invoice Header"."Customer Posting Group" = 'NON-EU IC')) THEN BEGIN
                            //    gTxtVat := TxtVat3;
                            //    gTxtFooter := TxtFooter3;
                            //END;
                            if VATBusPostingGroup.Get("Sales Invoice Header"."VAT Bus. Posting Group") then begin
                            ...
                            //RHE-TNA 24-05-2022 BDS-6346 BEGIN
                            else
                            ...
                            //RHE-TNA 24-05-2022 BDS-6346 END
                        end;
            ...
            begin
                ...
                IF "VAT Registration No." = '' THEN
                    VATNoText := ''
                ELSE
                    //ABC-EHO 06-06-2016 BEGIN
                    VATNoText := VatRegNoCaption;
                //VATNoText := FIELDCAPTION("VAT Registration No.");
                //ABC-EHO 06-06-2016 END
    ...
    var
        ...
        ExtDocNrLbl: Label 'External Document No.';
        CompanyInfoPhoneNoCaptionLbl: Label 'Phone No.';
        CompanyInfoVATRegNoCptnLbl: Label 'VAT Reg. No.';
        CompanyInfoGiroNoCaptionLbl: Label 'Giro No.';
        CompanyInfoBankNameCptnLbl: Label 'Bank';
        CompanyInfoBankIBANLbl: Label 'IBAN';
        CompanyInfoBankSWIFTLbl: Label 'Swift Code';
        CompanyInfoBankAccNoCptnLbl: Label 'Account No.';
        CompanyInfoBankLbl: Label 'Bank Information';
        CompanyInfoFaxNoLbl: Label 'Fax No.';
        BankAddress1: Label 'Stationsweg 5';
        BankAddress2: Label '8911AG Leeuwarden';
        ...
        PostedShipmentDateCaptionLbl: Label 'Shipment Date';
        ...
        FooterNote: Label 'Please quote the Invoice No. as reference when making your payment.';
        FreightLbl: Label 'Freight Terms';
        SalesRepLbl: Label 'Sales rep';
        //RHE-TNA 19-11-2021 BDS-5858 BEGIN
        ...
        VatRegNoCaption: Label 'VAT Registration No.';
        OrderNoCaption: Label 'Order No.';
        ItemNoCaption: Label 'Item';
    ...
    //RHE-TNA 25-05-2022 BDS-6364 BEGIN
    procedure SetPrintableLine(SalesLineToCheck: Record "Sales Invoice Line"): Boolean
    var
        Item: Record Item;
    begin
        if SalesLineToCheck.Type = SalesLineToCheck.Type::Item then begin
            if Item.Get(SalesLineToCheck."No.") then begin
